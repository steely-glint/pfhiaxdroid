...
public interface AudioFace {
    ...
    static final String version_id = "@(#)$Id: AudioFace.java,v 1.2 2011/03/06 15:10:50 uid1003 Exp $ Copyright Westhawk Ltd";
     ...
     * 
     * @param codec
     *            integer representing the codec to use. Must be one of the
     *            values in the array returned by getCodecs(). May be called on
     ...
     * microphone. Implementing class - eg IAXCall - will call
     * readStampedAudio() and then send data out over wire. AudioReceiver can be
     * null - in which case readStampedAudio() should be called directly.
     * 
     * @param r
     *            The AudioReceiver to be notified
     * @throws AudioException
    ...
    /**
     * Returns all the available properties of this audio channnel. eg:
     * <ol>
     * <li>playLevel</li>
     * <li>recLevel</li>
     * <li>ec</li>
