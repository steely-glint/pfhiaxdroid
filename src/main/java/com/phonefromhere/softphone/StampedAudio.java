 ...
 * Typically 20ms worth, but that is codec dependent.
 * 
 * Warning - you can't set the synchronized keyword on interfaces. All users
 * should synchronize access to implementations of this interface
 * 
...
public interface StampedAudio {
    ...
    static final String version_id = "@(#)$Id: StampedAudio.java,v 1.1 2011/02/03 14:33:15 uid1003 Exp $ Copyright Westhawk Ltd";
    ...
    /**
     * Returns the length of valid data. <em>access must be synchronized</em>
     * 
     * @return The length
     */
    int getLength();
