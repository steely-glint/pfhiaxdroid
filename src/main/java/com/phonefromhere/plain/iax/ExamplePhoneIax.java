...
public class ExamplePhoneIax implements GenericSoftphone {
    ...
    public static void main(String[] args) {
       ...
       ExamplePhoneIax test = new ExamplePhoneIax();
       test.setHost("lookafar.westhawk.co.uk");
       test.setUsername("tiger");
       test.setPassword("tiger");
       AudioFace audio = new DummyAudio();
