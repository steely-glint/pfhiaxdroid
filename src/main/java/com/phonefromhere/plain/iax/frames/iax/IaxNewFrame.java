...
import com.phonefromhere.plain.iax.frames.iax.ie.CallingPresType;
import com.phonefromhere.plain.iax.frames.iax.ie.CallingTonType;
import com.phonefromhere.plain.iax.frames.iax.ie.IEType;
import com.phonefromhere.plain.iax.frames.iax.ie.InformationElement;
...
public class IaxNewFrame extends IaxFrame {
    ...
    public void setSupportedMediaFormats(Collection<MediaFormat> formats) {
        ...
        Log.debug("setting format2");
        this.setFormat2(firstFormat);
    ...
    public void setCapability(long capability) {
        ...
        this.addInformationElement(ie);
        InformationElement ie2 = new InformationElement(IEType.CAPABILITY2);
        ie2.set8VersionedOctets(0,capability);
        this.addInformationElement(ie2);
        Log.debug("setting capability2");
    }
    ...
    public long getCapability() {
        ...
        ie = this.getInformationElement(IEType.CAPABILITY2);
        if (ie != null) {
            capability = ie.get8VersionedOctets();
        }
        return capability;
    }
