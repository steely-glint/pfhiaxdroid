...
public class AndroidAudioSpeaker implements Runnable {
    ...
    private static final String version_id = "@(#)$Id: AndroidAudioSpeaker.java,v 1.14 2011/03/23 09:22:42 uid100 Exp $ Copyright Westhawk Ltd";
    ...
    protected void writeStampedAudio(StampedAudio stampedAudio)
        ...
        if (_speaker != null) {
            ...
            if (_hasSpeakerStarted == false) {
                 ...
                 * AndroidLog.getLog().debug( this.getClass().getSimpleName() +
    ...
    @Override
    public void run() {
        AndroidLog.getLog().debug(this.getClass().getSimpleName() + ".run()");
        while (_me != null) {
    ...
    protected void destroy() {
        ...
        if (_speaker != null) {
            _speaker.release();
            AndroidLog.getLog().debug("\tspeaker released");
        }
    }
